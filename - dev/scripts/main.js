...
//             bigblock = $this.closest('.product__slideshow-thumb-img').siblings('.product__slideshow-block');
...
var Slideshow = (function(){
    ...
    var _changeSlide = function($this){
        var
            ...
            display = container.find('.product__slideshow-img');

        $this.closest('.product__slideshow-item').addClass('active')
